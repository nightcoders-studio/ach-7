...
| 4.8 | Status Pesanan | Tracking timeline: Menunggu → Selesai | ✅ |
| 4.9 | Riwayat Pesanan | Daftar semua pesanan konsumen + filter status | ✅ |
| 4.10 | Konfirmasi Terima + Rating | Tombol terima + bintang 1-5 + komentar | ✅ |
| 4.11 | Profil Konsumen | Lihat/edit data diri, stats belanja, logout | ✅ |

> **Legenda:** ✅ = selesai, 🟡 = API siap UI belum, ⬜ = belum sama sekali
...
5. 🟡 = API sudah siap, tinggal frontend-nya.
